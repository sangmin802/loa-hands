						...
						indentStringGroup: [
							{
								...
								desc: [
									...
									{
										val: "[바드] [<FONT COLOR='#FFD200'>윈드 오브 뮤직</FONT>] 선율 증가 <FONT COLOR='#73dc04'>Lv +1</FONT>",
										active: null,
									},
									{
						...
						indentStringGroup: [
							{
								...
								desc: [
									...
									{
										val: "[바드] [<FONT COLOR='#FFD200'>사운드 홀릭</FONT>] 사운드 집중 <FONT COLOR='#73dc04'>Lv +3</FONT>",
										active: null,
									},
								],
							},
			...
			skills: [
				{
					...
					detail: {
						...
						tripodSkillCustom: [
							{
								name: '폭파 유지',
								desc: '사운드 쇼크가 소멸되는 위치에 잔해가 남아 2.0초간 적들에게 30.0%의 추가 피해를 준다.',
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_1_8.png',
							},
							{
								name: '성스러운 쇼크',
								desc: '[성] 속성으로 변경되고, 사운드 쇼크에 적중된 적에게 2.0초간 음표 낙인이 생겨 자신 및 파티원이 주는 피해가 10.0% 증가한다.',
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_18.png',
							},
							{
								name: '연사',
								desc: '사운드 쇼크를 연속으로 2회 발사한다.',
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_3_54.png',
							},
						],
						rune: {
					...
					detail: {
						...
						tripodSkillCustom: [
							...
							},
							{
								...
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_23.png',
							},
							{
								name: '빛의 보호',
								desc: [
								...
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_3_65.png',
							},
						],
						rune: {
				...
				},
				{
					...
					detail: {
						...
						tripodSkillCustom: [
							...
							{
								name: '선율 증가',
								desc: '윈드 오브 뮤직으로 회복하는 세레나데 게이지가 168.0% 증가한다.',
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_64.png',
							},
							{
								name: '수호의 바람',
								desc: '시전 시 자신 및 윈드 오브 뮤직에 적중된 파티원에게 4.0초간 자신의 최대 생명력의 28.0%까지 흡수하는 보호막을 생성한다.',
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_3_75.png',
							},
						],
						rune: {
						...
						tripodSkillCustom: [
							{
								...
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_1_23.png',
							},
							{
								name: '광휘의 음파',
								desc: '[성] 속성으로 변경되고, 자신 또는 파티원이 음파 진동 영역 및 잔류물 영역에 들어오면 2.0초 동안 공격력이 버프 시전자의 기본 공격력의 15.0%만큼 더해지며, 전체 공격력이 6.0% 증가한다.',
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_18.png',
							},
							{
						...
						tripodSkillCustom: [
							{
								...
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_1_34.png',
							},
							{
								name: '강인함',
							...
							{
								name: '날렵한 시전',
								desc: '시전 속도가 20.0% 증가하고 치명타 적중률이 50.0% 증가한다.',
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_3_6.png',
							},
						],
						rune: {
						...
						tripodSkillCustom: [
							{
								...
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_1_6.png',
							},
							{
								name: '끝나지 않는 수호',
								desc: '수호의 연주 버프가 유지시간에 의해 종료되면, 8.0초간 자신의 최대 생명력의 18.0%에 해당하는 보호막을 추가로 생성한다.',
								grade: 8,
								src: '//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_75.png',
							},
							{
								name: '수호의 바람',
