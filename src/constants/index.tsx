          ...
          indentStringGroup: [
            {
              ...
              desc: [
                ...
                {
                  val:
                    "[바드] [<FONT COLOR='#FFD200'>수호의 연주</FONT>] 끝나지 않는 수호 <FONT COLOR='#73dc04'>Lv +2</FONT>",
                  active: null,
                },
                {
                  val:
          ...
          indentStringGroup: [
            {
              ...
              desc: [
                ...
                {
                  val:
                    "[바드] [<FONT COLOR='#FFD200'>사운드 홀릭</FONT>] 집중 포화 <FONT COLOR='#73dc04'>Lv +2</FONT>",
                  active: null,
                },
              ],
            },
          ...
          detail: {
            ...
            tripodSkillCustom: [
              ...
              },
              {
                ...
                grade: 8,
                src:
                  "//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_61.png",
              },
              {
                name: "화음 강화",
            ...
            tripodSkillCustom: [
              {
                ...
                grade: 8,
                src:
                  "//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_1_7.png",
              },
              {
                name: "얼어붙은 낙인",
                desc:
                  "[수] 속성으로 변경되어, 시드 이하 적에게 주는 피해가 30.0% 증가하고, 3.0초간 이동속도를 50.0% 감소시키고, 더 이상 경직을 발생시키지 않지만 짧은 시간 내 3 회 적중 시 4.0초간 동결상태로 만든다.",
                grade: 8,
                src:
                  "//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_14.png",
              },
              {
                name: "고통의 낙인",
            ...
            tripodSkillCustom: [
              {
                name: "수호의 진동",
                desc:
                  "음파 진동의 구체를 적에게 적중 시 자신에게 3.0초간 보호막이 생성되고, 적중된 적 1명당 5.0% 씩 최대 30.0% 까지 증가한다.",
                grade: 8,
                src:
                  "//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_1_75.png",
              },
              {
                name: "얼어붙은 핵",
                desc:
                  "[수] 속성으로 변경되어, 시드 이하 적에게 주는 피해가 50.0% 증가하고, 더 이상 적에게 피격이상을 걸지 않지만, 지상에 음파를 생성해, 가운데로 끌어당겨 4.0초간 이동속도를 40.0% 감소시키고, 짧은 시간 내 5회 적중 시 3.0초간 동결상태로 만든다.",
                grade: 8,
                src:
                  "//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_14.png",
              },
          ...
          detail: {
            ...
            tripodSkillCustom: [
              ...
              },
              {
                name: "집중 포화",
                desc:
                  "방향전환이 불가능해지며, 지속 시간이 50.0% 감소하여 판정횟수가 5회로 줄어들지만 각 공격이 적에게 주는 피해가 828.0% 증가한다. 지속력 강화 트라이포드 적용시, 판정횟수가 7회로 감소한다.",
                grade: 8,
                src:
            ...
            tripodSkillCustom: [
              {
                ...
                grade: 8,
                src:
                  "//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_1_61.png",
              },
              {
                name: "낙뢰 강화",
                desc: "적에게 주는 피해가 100.0% 증가한다.",
                grade: 8,
                src:
                  "//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_1.png",
              },
              {
                name: "강력한 서곡",
                desc:
          ...
          detail: {
            ...
            tripodSkillCustom: [
              ...
              },
              {
                name: "죽음의 증폭",
                desc:
                  "죽음의 끝으로 주는 피해 증폭량이 중첩당 50.0% 더 증가한다.",
                grade: 8,
                src:
                  "//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_1.png",
              },
              {
                name: "죽음의 아리아",
                desc:
                  "죽음의 전주곡으로 주는 선율 피해가 30.0% 증가하고 죽음의 전주곡에 적중된 대상이 죽음의 끝 디버프가 풀리기 전에 죽으면 3.0m 범위 안의 가장 가까운 적 1명에게 652740의 추가 피해를 준다.",
                grade: 8,
                src:
                  "//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_3_50.png",
              },
            ],
            rune: {
              runeInfo: [
          ...
          detail: {
            ...
            tripodSkillCustom: [
              ...
              },
              {
                ...
                grade: 8,
                src:
                  "//cdn-lostark.game.onstove.com/EFUI_IconAtlas/Tripod_Tier/Tripod_Tier_2_40.png",
              },
              {
                name: "거대 하프",
                desc:
