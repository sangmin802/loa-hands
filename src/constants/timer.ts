...
export const LOWEN = [
	[
		...
		},
		{
			...
			lv: 1490,
			position: '툴루비크',
			src: '/img/lowen/lowen_battle.png',
			time: ['22:00'],
			endTime: '22:00',
		},
		{
...
export const FIELD_BOSS = [
	[
		...
		},
		{
			...
			name: '헤르무트',
			lv: 1490,
			position: '로웬-레갸르방크 대평원',
			src: '/img/boss/boss_15.png',
			time: partTime1,
			additionalTime: partTime2,
			endTime: endTime,
			contType: 'FIELD_BOSS',
		},
		{
			...
			name: '이스라펠',
			lv: 1540,
			position: '엘가시아-필레니소스 산',
			src: '/img/boss/boss_16.png',
			time: partTime1,
			additionalTime: partTime2,
			endTime: endTime,
			contType: 'FIELD_BOSS',
