...
import Timer from '@/pages/home/timerList/timerItem/timerItem';
...
describe('Timer1', () => {
	...
	it('normal', () => {
		...
		const { getByTestId } = render(
			<Timer data={initialData} dispatcher={{ setTime, notification }} />,
		);
	...
	it('close', () => {
		...
		render(<Timer data={initialData} dispatcher={{ setTime, notification }} />);
